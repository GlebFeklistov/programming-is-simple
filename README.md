...
### Простые типы данных
> Подразделяются на простые и сложные, данные простого типа это - символы, числа и т.п. элементы, дальнейшее дробление которых не имеет смысла. Из простых типов данных формируются сложные типы данных или структуры.

### Структурированные данных
> Под структурированными типами данных в общем случае понимают набор из простых типов данных и множество связей между ними.
