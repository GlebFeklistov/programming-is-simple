...
## Цель
> Цель данного пособия — показать, что между языками программирования намного больше общего, чем кажется на первый взгляд, выбор языка не является ключевым моментом, развеять миф, что этому учатся долгие годы, необходимы специфические знания, высокий уровень IQ и т.д.
