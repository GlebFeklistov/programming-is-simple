...
#### Выражения
> Выражение — конструкция на языке программирования, предназначенная для выполнения вычислений. Комбинация значений, констант, переменных, операций и функций, которая может быть вычислена в соответствии с правилами конкретного языка.

Результатом вычисления выражения является величина определенного типа. Если эта величина имеет числовой тип, то такое выражение называется арифметическим.

Все что находится в правой части после присваивания является выражением.
