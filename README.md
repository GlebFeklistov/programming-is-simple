...
## Цель
> Цель данного пособия — показать, что между языками программирования намного больше общего, чем кажется на первый взгляд. 
Развеять миф, что этому учатся долгое время и необходимы специфические знания, физиологические предрасположенности, высокий уровень IQ, быть по меньшей мере гением. 
Показать, что как и в любом другом виде деятельности за которую берется человек на протяжении всей своей задокументированной истории, он всегда проходит две точки: от полного нуля до стадии возведения это в исскуство. Руководствуясь лишь идеей, желанием и целеустремленность, все необходимое он приобретает в течении этого пути. Но в начале нет ничего.
В программировании мы ничего изобратеть не будет и потому в состоянии полного нуля у нас уже есть все необходимое.
У вас еще нет навыков и знаний, но есть самое главное, чужие наработки интернет и эта штука между ушей, потому я предлагаю начать использовать её по целевому назначению — а именно, напрягать мозг и развивать кортекс.
...
В качестве основного языка согласно статистике был выбран JavaScript (NodeJS). На данной странице будут демонстрироваться примеры кода написанные именно на нем. Большинство этого кода можно будет выполнить прямо в консоли браузера.
Код с комментариями на других языках будет доступен по ссылкам под примерами.
