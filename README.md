...
Во всяком языке программирования определены способы организации данных и способы организации действий над данными. Несмотря на разнообразие языков программирования высокого уровня, их изучение происходит приблизительно по одной схеме. Это связано с общностью структуры различных языковя, которая отражена на схеме:
...
Также рекомендуется давать идентификаторам осмысленные и не сильно длинные имена, это упростит в дальнейшем семантический анализ программы. 
