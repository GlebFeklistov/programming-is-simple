...
GitHub опубликовал собственный рейтинг [10 самых популярных языков программирования в 2018 году](https://octoverse.github.com/projects#languages). [Согласно этой статистики](https://githut.info) были выбраны 6 наиболее востребованных языков программирования в настоящее время:
