...
Данные могут быть представлены различным образом: изображение, текста, звука.

### Типы данных
> Подразделяются на простые и сложные, данные простого типа это - символы, числа и т.п. элементы, дальнейшее дробление которых не имеет смысла. Из элементарных данных формируются сложные типы данных или структуры.
