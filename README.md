...
Цель данного пособия — показать, что между языками программирования высокго уровня много общего и выбор языка не является каким либо фундаментальным рещением в жизни разработчика.

Информация представленная здесь является результатом анализа других источников и попыткой структурировать этот материал в целях объяснения понятным языком основ написания программ.
Материал не является полноценным руководством по программированию так, как он абстрагируется от конкретного языка программирования. 
Пособие можно рассматривать в качестве введения в базовые концепции программирования.

Этот материал написан для тех, кто:

* не знает с чего начать
* хочет познакомиться с базовыми понятиями
* хочет понять чем заняты разработчики
...
- [Общие черты](#%D0%BE%D0%B1%D1%89%D0%B8%D0%B5-%D1%87%D0%B5%D1%80%D1%82%D1%8B)
- [Языки программирования высокого уровня](#%D1%8F%D0%B7%D1%8B%D0%BA%D0%B8-%D0%BF%D1%80%D0%BE%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F-%D0%B2%D1%8B%D1%81%D0%BE%D0%BA%D0%BE%D0%B3%D0%BE-%D1%83%D1%80%D0%BE%D0%B2%D0%BD%D1%8F)
- [Элементы языков](#%D1%8D%D0%BB%D0%B5%D0%BC%D0%B5%D0%BD%D1%82%D1%8B-%D1%8F%D0%B7%D1%8B%D0%BA%D0%BE%D0%B2)
...
Данной блок схеме соответствует следующий фрагмент кода, который проверяет утрверждение, что значение "a" больше 10, в случае выполнения этого условия выведет в консоль сообщение "a больше 10", в противном случае выведет другую ветку кода следующую за оператором "else":
...
Данной блок схеме соответствует следующий фрагмент кода, который проверяет утрверждение, что значение переменной "a" больше или равно 10, в случае выполнения этого условия в консоль будет выведен текст, в противном случае программа пропусти набор комманд и продолжит своё выполнение:
...
Данной блок схеме соответствует следующий фрагмент кода, здесь предусмотретрены три логические ветви, в первом случае если в переменную "a" присвоено значение 'Волк' или 'Заяц' будет выведена в консоль строка содержащая имя этого персонажа, во всех остальных случаях будет выведена строка из ветка 'default':
