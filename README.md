...
* Литералы: цифры, строки, символы и т.д.
...
В целях еще большего упрощения семантического анализа, рекомендуется документировать участки кода сложные для понимания или выполняющие специфические функции.
...
Примеры некоторых ключевых слов в JavaScript
* break
* case
* class
* catch
