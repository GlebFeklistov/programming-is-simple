...
Удобство использования модулей заключается в возможности обновления или замены модуля, без необходимости изменения остальной программы и является средством разбиения задачи на простые подзадачи реализующие только одну функцию основной задачи.

В модули можно выносить части программы доступ к которым необходим в разных частях проекта или других модулях. Таким образом сложность первоначальной задачи распределяется по отдельным модулям. 
