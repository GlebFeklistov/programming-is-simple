...
## Высокоуровневые языкы программирования 

GitHub опубликовал собственный рейтинг [10 самых популярных языков программирования в 2018 году](https://octoverse.github.com/projects#languages). Согласно этой статистики были выбраны 6 наиболее востребованных языков программирования в настоящее время:
...
Дополнительно был добавлен Pascal, т.к. он используется для обучения программированию в старших классах и на первых курсах вузов, является основой для ряда других языков. Он добавит контраста в гамму различий сиснтаксических парадигм других языков программирования, поможет переосмыслить пройденный путь и немного поностальгировать.

На данной странице будут демонстрироваться примеры кода написанные на JavaScript (NodeJS). Код с комментариями на других языках будет доступен по ссылкам под примерами.
