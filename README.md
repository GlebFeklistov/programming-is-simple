...
### Комментарии
> Комментарии - пояснения к исходному тексту программы, находящиеся непосредственно внутри исходного кода программы. 
...
В примерах на этой странице будут использованы два типа комметанриев:
* Однострочные: //
* Многострочные: /* \*/
