...
Константа (в программировании) — способ адресации данных, изменение которых рассматриваемой программой не предполагается или запрещается. При попытке изменить значение объявлённой константы возникает ошибка. 

Для чего нужны константы? Для хранения постоянной информации. Вспомните физику или математику – гравитационная постоянная, температура по Кельвину, скорость света, отношение длины окружности к диаметру и т.п. Все это – константы.
